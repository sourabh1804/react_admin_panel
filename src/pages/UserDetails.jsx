...
const UserDetails = () => {
  const { id } = useParams(); // URL se user ID le raha hai
  ...
  if (loading) return <Loader />; // Loading component dikhaye jab tak data nahi aata
      ...
      <div className="bg-white w-full max-w-3xl rounded-2xl shadow-lg p-6">
        ...
        <div className="mb-6">
          ...
          <div className="border rounded-lg p-4 space-y-1">
            ...
            <p className="text-sm text-gray-500">Lat: {user.address.geo.lat}, Lng: {user.address.geo.lng}</p>
          </div>
        </div>
